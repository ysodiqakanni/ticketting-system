...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Departments>(entity =>
            {
                ...
                entity.ToTable("departments", "db_a3d3ad_pricing");
            ...
            modelBuilder.Entity<StaffDetails>(entity =>
            {
                ...
                entity.ToTable("staff_details", "db_a3d3ad_pricing");
            ...
            modelBuilder.Entity<StaffNotes>(entity =>
            {
                ...
                entity.ToTable("staff_notes", "db_a3d3ad_pricing");
            ...
            modelBuilder.Entity<StaffTerritory>(entity =>
            {
                ...
                entity.ToTable("staff_territory", "db_a3d3ad_pricing");
            ...
            modelBuilder.Entity<Territories>(entity =>
            {
                ...
                entity.ToTable("territories", "db_a3d3ad_pricing");
